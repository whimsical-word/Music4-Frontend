...
const HomePage = () => {
    ...
    if (isLoading) {
        return (
            <div className="p-6 bg-[#0d131a] min-h-screen flex items-center justify-center font-sans">
                <div
                    className="w-10 h-10 border-4 border-white/[0.05] border-t-sky-500 rounded-full animate-spin"></div>
            </div>
        );
    }
    ...
    return (
        <div
            className="p-6 pb-32 font-sans text-slate-100 bg-[#0d131a] min-h-screen selection:bg-sky-600 selection:text-white">
            {/* KHỐI BANNER CHÀO MỪNG */}
            <div
                className="mb-10 p-8 rounded-xl bg-gradient-to-r from-[#0f1722] to-[#131e2e] border border-white/[0.05] shadow-md relative overflow-hidden">
            ...
            <div className="space-y-12 animate-fadeIn">
                ...
                {aiRecommendations.length > 0 && (
                    <AutoScrollCarousel
                        title={
                            <span
                                className="flex items-center gap-2 text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-fuchsia-500">
                        ...
                        renderItem={(track) => {
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        className="relative w-full h-[150px] md:h-[168px] mb-4 rounded-xl overflow-hidden bg-[#0a0f14] shadow-inner flex-shrink-0">
                                        <MusicImage
                                            src={track.img}
                                            type="track"
                                            alt={track.name}
                ...
                <AutoScrollCarousel
                    ...
                    renderItem={(album) => (
                        ...
                        >
                            ...
                            <div
                                className="relative aspect-square w-full h-[150px] md:h-[168px] mb-4 overflow-hidden bg-white/[0.02] shadow-md flex-shrink-0">
                                <MusicImage
                                    src={album.img}
                                    type="album"
                                    alt={album.name}
                                ...
                                <div
                                    ...
                                    <button
                                        className="w-11 h-11 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full flex items-center justify-center shadow-md transform translate-y-3 group-hover:translate-y-0 transition-all duration-300 border-none cursor-pointer">
                                        <Play
                                            size={20}
                                            fill="currentColor"
                ...
                <AutoScrollCarousel
                    ...
                    renderItem={(track) => (
                        ...
                        >
                            <div
                                className="relative w-full h-[150px] md:h-[168px] mb-4 rounded-md overflow-hidden bg-white/[0.02] shadow-md flex-shrink-0">
                                <MusicImage
                                    src={track.img}
                                    type="track"
                                    alt={track.name}
                ...
                <AutoScrollCarousel
                    ...
                    renderItem={(artist) => (
                        ...
                        >
                            <div
                                className="w-28 h-28 md:w-32 md:h-32 mx-auto mb-4 rounded-full overflow-hidden border border-white/[0.05] relative bg-white/[0.02] shadow-md flex-shrink-0">
                                <MusicImage
                                    src={artist.img}
                                    type="artist"
                                    alt={artist.name}
                                ...
                                <div
                                    ...
                                    <div
                                        className="w-10 h-10 bg-sky-500 rounded-full flex items-center justify-center shadow-md transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                                ...
                                {top5Tracks.map((track, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div
                                                className="col-span-1 flex items-center justify-center flex-shrink-0 min-w-[48px]">
                                                <div
                                                    className="w-12 h-12 rounded-md overflow-hidden bg-white/[0.02] relative shadow-md flex-shrink-0 min-w-[48px] min-h-[48px]">
                                                    <MusicImage
                                                        src={track.img}
                                                        type="track"
                                                        alt={track.name}
                                  ...
                                  >
                                    {artist.name}
                                            ...
                                            {/* CỘT 4: SỐ LƯỢT NGHE */}
                                            <div
                                                className="col-span-3 text-right flex flex-col items-end justify-center flex-shrink-0">
                        <span
                            className="text-sm font-semibold text-white font-mono bg-white/[0.04] px-3 py-1.5 rounded-full border border-white/[0.05] group-hover:border-sky-500/30 transition-colors whitespace-nowrap">
                          {track.viewCount?.toLocaleString() || 0}{" "}
                            ...
                            <div
                                className="text-center text-sm text-slate-500 p-8 border border-dashed border-white/[0.05] rounded-xl">
