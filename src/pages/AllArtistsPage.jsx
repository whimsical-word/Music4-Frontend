                        ...
                        {artists.map((artist) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="bg-[#181818] p-5 rounded-xl hover:bg-[#282828] transition-all duration-300 group cursor-pointer border border-transparent hover:border-[#3e3e3e] flex flex-col justify-between items-center"
                                >
                                    <div className="w-full text-center">
                                        ...
                                        <h4 className="font-bold text-white truncate text-sm mb-1 group-hover:text-blue-400 transition-colors w-full px-1">{artist.name}</h4>
                                        <p className="text-[11px] text-[#a7a7a7] font-medium tracking-wider uppercase mb-3">Artist</p>
                                    </div>
