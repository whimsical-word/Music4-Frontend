    ...
    const fetchAllArtists = async () => {
      ...
      try {
        const res = await axiosClient.get(
          `/artists?page=${currentPage}&size=${pageSize}`,
        );
              ...
              return (
                ...
                >
                  <div className="w-full text-center">
                    ...
                    <h4
                      className="font-bold text-white truncate text-sm mb-1 group-hover:text-sky-400 transition-colors w-full px-1"
                      title={artist.name}
                    >
                      {artist.name}
                    </h4>
                    <p className="text-[11px] text-slate-400 font-medium tracking-wider uppercase mb-3">
                      Artist
                    </p>
                  </div>
