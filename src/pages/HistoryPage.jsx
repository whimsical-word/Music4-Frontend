...
import { ArrowLeft, Clock, Play, Pause, RefreshCw } from "lucide-react"; // Import thêm RefreshCw
...
const HistoryPage = () => {
  ...
  useEffect(() => {
    const handleAutoRefresh = () => {
      // Tăng trigger lên 1 để useEffect fetch data tự động chạy lại
  ...
  return (
    <div className="bg-[#121212] min-h-screen text-white p-8 pb-32">
      ...
      {/* Cập nhật UI khu vực Tiêu đề và thêm nút Làm mới */}
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center gap-2 bg-[#282828] hover:bg-[#3e3e3e] text-white px-4 py-2 rounded-full font-medium transition-colors border-none cursor-pointer disabled:opacity-50"
        >
