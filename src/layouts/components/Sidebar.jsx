...
const Sidebar = () => {
    ...
    return (
        <div
            className="w-64 bg-[#0d131a] p-6 flex flex-col h-full border-r border-white/[0.05] hidden md:flex font-sans text-slate-400">

            {/* LOGO BRANDING */}
            <Link to="/" className="flex items-center gap-3 mb-8 cursor-pointer group">
                <img src="/favicon.svg" alt="Music4 Logo"
            ...
            {role === 'admin' && (
                <div className="mt-8 pt-6 border-t border-white/[0.05] flex flex-col gap-2 font-medium">
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2 px-1">Quản trị hệ
                        thống</p>
                    <button onClick={() => handleAdminTabChange('overview')}
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.05] flex flex-col gap-1 font-medium">
                    ...
                    {isDropdownOpen && (
                        <div className="mt-1 flex flex-col gap-1 transition-all duration-300">
                            ...
                            <div className="max-h-[260px] overflow-y-auto custom-scrollbar flex flex-col gap-1 mt-1"
                                 ref={menuRef}>
                                <ul className="flex flex-col gap-1 text-sm p-0 m-0 list-none">
                                    {playlists.length > 0 ? (
                                        playlists.map((pl) => {
                                            ...
                                            return (
                                                <li key={pl.id} className="w-full relative group/item">
                                                    ...
                                                    {isMenuOpen && (
                                                        <div
                                                            className="absolute right-2 top-9 bg-[#161f2c] border border-white/[0.08] rounded-lg shadow-xl z-50 py-1 w-28 flex flex-col animate-in fade-in slide-in-from-top-1 duration-150">
                                                            <button
                                        ...
                                        <li className="text-xs text-slate-600 italic py-2 px-3 pl-11">Chưa có danh sách
                                            phát</li>
                                    )}
                                </ul>
                            </div>
