        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center w-2/4 gap-2">
                    ...
                    <div className="w-full max-w-md flex items-center gap-3 group">
                        ...
                        >
                            ...
                            >
                                <div
                                    className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-3 h-3 bg-white rounded-full shadow opacity-0 group-hover:opacity-100 transition-opacity"
                                />
                            </div>
                        </div>

                        <span className="text-[11px] font-mono text-[#a7a7a7] min-w-[35px] text-left">
                            {formatTime(!isAuthenticated ? PREVIEW_LIMIT : (duration || currentTrack?.duration))}
                        </span>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-end w-1/4 gap-3 text-[#a7a7a7]">
                    ...
                    >
                        ...
                        >
                            <div
                                className="absolute right-0 top-1/2 transform -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow"
                            />
                        </div>
                    </div>
                </div>
            ...
            {showGuestModal && (
                <div
                    ...
                    <div
                        className="bg-[#181818] border border-[#3e3e3e] p-8 rounded-2xl w-[90%] max-w-md shadow-2xl text-center flex flex-col items-center">
                        <div
                            className="w-16 h-16 bg-blue-500/20 text-blue-500 flex items-center justify-center rounded-full mb-5 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                            <Lock size={32}/>
                        </div>
                        <h3 className="text-2xl font-black text-white mb-3 tracking-tight">Khám phá không giới hạn</h3>
                        <p className="text-sm text-[#a7a7a7] mb-8 leading-relaxed px-2">
                            Bạn đang sử dụng phiên bản dùng thử 30 giây. Hãy đăng nhập tài khoản miễn phí để mở khóa
                            toàn bộ bài hát, tạo danh sách phát, tương tác cộng đồng và nhiều đặc quyền khác!
                        </p>
